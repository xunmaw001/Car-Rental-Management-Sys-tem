...
public class QichezulinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,QichezulinEntity qichezulin, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			qichezulin.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,QichezulinEntity qichezulin, HttpServletRequest request){
        EntityWrapper<QichezulinEntity> ew = new EntityWrapper<QichezulinEntity>();
		PageUtils page = qichezulinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, qichezulin), params), params));
        return R.ok().put("data", page);
    }
