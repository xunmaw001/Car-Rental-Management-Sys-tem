...
public class DingzhixinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DingzhixinxiEntity dingzhixinxi, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			dingzhixinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DingzhixinxiEntity dingzhixinxi, HttpServletRequest request){
        EntityWrapper<DingzhixinxiEntity> ew = new EntityWrapper<DingzhixinxiEntity>();
		PageUtils page = dingzhixinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, dingzhixinxi), params), params));
        return R.ok().put("data", page);
    }
